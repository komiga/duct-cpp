...
public:
	...
	static DynamicEncoder const&
	utf8_static() noexcept {
		static DynamicEncoder const
		s_de_utf8{duct::Encoding::UTF8};

		return s_de_utf8;
	}

	static DynamicEncoder const&
	utf16_static() noexcept {
		static DynamicEncoder const
		s_de_utf16{duct::Encoding::UTF16};

		return s_de_utf16;
	}

	static DynamicEncoder const&
	utf32_static() noexcept {
		static DynamicEncoder const
		s_de_utf32{duct::Encoding::UTF32};
