...
/** @name Constructors and destructor */ /// @{
	...
	*/
	CharacterRange(char32 const first, unsigned const length)
		: m_first{first}
		, m_last{first+length}
	{}
	/** Copy constructor. */
...
/** @name Properties */ /// @{
	...
	*/
	void set_first(char32 const first) { m_first=first; }
	/**
		Get first code point.
		@returns The first code point in range.
	*/
	char32 first() const { return m_first; }
	/**
		Set last code point.
		@param last New last code point.
	*/
	void set_last(char32 const last) { m_last=last; }
	/**
		Get last code point.
		@returns The last code point in range.
	*/
	char32 last() const { return m_last; }
/// @}
...
/** @name Comparison */ /// @{
	...
	*/
	signed compare(CharacterRange const& other) const {
